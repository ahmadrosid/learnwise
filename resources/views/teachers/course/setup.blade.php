        ...
        <div class="d-flex justify-content-between">
            ...
            <div class="gap-1 d-flex">
                <form action="/teacher/course/{{ $course->id }}/publish" method="POST">
                    ...
                    <button class="btn btn-primary" type="submit" {{ $completionProgressValue < 6 || $hasBeenSold ? 'disabled' : '' }}>
            ...
            <div class="col">
                ...
                <div class="py-4" x-data="{ open: false }">
                    <div class="p-2 px-3 border rounded-2 bg-neutral-30 border-neutral-40">
                        ...
                        <div class="pt-1 {{ !$course->category_id ? 'text-muted fst-italic text-xs' : ' text-sm ' }}" x-show="!open">
