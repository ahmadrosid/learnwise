            ...
            <div class="card" style="position: sticky; top:65px;">
                <div class="card-img-top position-relative video-preview-btn" data-video-id="{{ $firstFreeChapter }}">
                    ...
                    <div class="top-0 left-0 bg-black video-preview-overlay d-flex align-items-center justify-content-center w-100 h-100 position-absolute card-img-top"
                        style="opacity:0.2" @click="previewChapter('{{ $firstFreeChapter }}')">
                    </div>
                    <div class="z-30 p-0 bg-primary rounded-circle position-absolute video-preview-btn"
                        ...
                        @click="previewChapter('{{ $firstFreeChapter }}')">
                ...
                <div class="modal-body">
                    ...
                    <div class="my-4 accordion" id="previewAccordion">
                        @foreach ($freeChapters as $chapter)
                            <a @click="handlePreviewLink"
                                class="py-2 px-4 d-flex justify-content-between modal-video-preview-link align-items-center"
                                data-video-id="{{ $chapter->video_url }}">
                                ...
                                <div class="gap-2 d-flex align-items-center">
                                    <span>Preview</span>
                                    <span
                                        class="text-decoration-none">{{ $chapter->video_duration ? $chapter->video_duration : '' }}</span>
                                </div>
                            </a>
                        @endforeach
                    </div>
